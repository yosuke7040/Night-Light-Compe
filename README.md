...
Public :0.491471 27位
Private:0.498561 16位
正直オリジナリティ出したらスコア下がったしなんもしてねえ・・・
...
## ------------------------------------------------------------
後日
 - 結局ベースラインのnbにおんぶにだっこだった
 - 自分で考えたのはうまくいかず、target encodingも難しいなこれは
 - 正規化と標準化と正則化ごちゃまぜになってた
 - 標準化したのをbinningするのは無理なのか？
### nb006のコピー
 - rankとbinとbinのtarget encodingの特徴量をnb006に追加
 - CV:0.5323
 - 一番よくなったぞ！！！！！！！
 - だがしかしlate subシステムがないのであった・・・悲しい
